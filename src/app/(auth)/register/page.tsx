          ...
          <form onSubmit={handleSubmit}>
           ...
           <div className="mt-6 pt-6 border-t border-white/20">
             <div className="text-center mb-4">
               <p className="text-blue-200 text-sm mb-2">Or continue with</p>
             </div>
             
             <button
               onClick={handleGoogleSignIn}
               disabled={isLoading}
               className="w-full bg-white text-gray-800 font-semibold py-3 px-6 rounded-lg hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed transition-all transform hover:scale-105 flex items-center justify-center space-x-3"
             >
