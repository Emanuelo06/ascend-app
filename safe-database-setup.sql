-- ASCEND App Safe Database Setup
-- This script safely creates tables and policies, handling existing objects gracefully
...
BEGIN
    ...
    RAISE NOTICE '📊 Created tables: user_profiles, user_xp, life_audit_assessments, user_goals, habits, habit_checkins, challenges, user_achievements';
